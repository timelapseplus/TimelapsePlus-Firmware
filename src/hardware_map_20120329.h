...
#define HARDWARE_VERSION 20120329
...
#define BT_ALARM_PIN 2, C
#define BT_RTS_PIN 5, E
#define BT_CTS_PIN 3, F

/* POWER IO */
#define POWER_HOLD_PIN 4, C
