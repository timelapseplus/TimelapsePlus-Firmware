...
void hardware_light_start(void);
void hardware_light_stop(void);
uint16_t hardware_light_read_raw(void);
float hardware_light_read_lux(void);
void hardware_light_set_range(uint8_t range);
int8_t hardware_light_read_ev(void);
float hardware_light_read_integrated_ev(uint8_t integration_minutes);
void hardware_light_auto_set_range(void);
