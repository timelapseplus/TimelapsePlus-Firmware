...
int main(void)
{
	...
	puts_P(PSTR("Printer Host Demo running.\r\n"));
...
void SetupHardware(void)
{
  ...
  PORTC &= ~_BV(PC3); // .
	...
	DDRB |= 1<<5; //Set LCDVCC HIGH
	PORTB |= 1<<5;
	DDRB |= 1<<4; //Set LCDLED HIGH
	PORTB |= 1<<4;
...
void PrinterHost_Task(void)
{
	...
	char     TestPageData[] = "\033%-12345X\033E" "Printed by the Timelapse+ USB Host Mode Demo - March 29rd, 2012\r\n\r\nHi Jackie! :)" "\033E\033%-12345X";
